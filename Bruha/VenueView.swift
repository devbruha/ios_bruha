...
class VenueView: UIView {
    ...
    var names:[String] = ["Featured","ALL Events","Today","This Weekend","Next Weekend","Running Man","Plane Ticket"] //this is where you load data from database
